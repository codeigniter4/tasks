...
class CronExpressionTest extends TestCase
{
    ...
    {
        $this->cron->testTime('6:00 PM');
        $this->assertTrue($this->cron->shouldRun('00 * * * *'));

        $this->cron->testTime('6:10 PM');
    ...
    {
        $baseTime = \CodeIgniter\I18n\Time::parse('6:30 am', 'UTC');
        $expectedTime = clone($baseTime);
        $expectedTime = $expectedTime->setTimezone(new DateTimeZone('America/Chicago'));
        dd($baseTime, $expectedTime);
    }
}
